  ...
  const certifications: Certification[] = [
    {
      ...
      date: '2024',
      description: 'Comprehensive Python programming certification covering advanced concepts, data structures, algorithms, and application development.',
      skills: ['Python', 'Data Structures', 'Algorithms', 'OOP', 'Libraries', 'Backend Development'],
      credentialUrl: 'https://www.geeksforgeeks.org/certificate/python',
      icon: '🐍',
      color: '#3776ab',
    ...
    },
    {
      ...
      issuer: 'HackerRank',
      date: '2024',
      description: 'JavaScript programming certification covering ES6+ features, asynchronous programming, and modern web development practices.',
      skills: ['JavaScript ES6+', 'DOM Manipulation', 'Async/Await', 'Functions', 'Event Handling', 'API Integration'],
      credentialUrl: 'https://www.hackerrank.com/certificates/javascript',
      icon: '⚡',
      color: '#f7df1e',
      category: 'programming',
      status: 'completed',
    ...
    {
      id: 'web-development-internshala',
      ...
      skills: ['HTML5', 'CSS3', 'JavaScript', 'React.js', 'Node.js', 'Database Integration', 'Responsive Design'],
      credentialUrl: 'https://trainings.internshala.com/web-development',
      icon: '🌐',
      color: '#667eea',
      category: 'web',
      status: 'completed',
    ...
    },
    {
      ...
      issuer: 'HackerRank',
      date: '2024',
      description: 'CSS certification covering advanced styling techniques, layouts, animations, and responsive design principles.',
      skills: ['CSS3', 'Flexbox', 'Grid Layout', 'Animations', 'Responsive Design', 'Modern CSS'],
      credentialUrl: 'https://www.hackerrank.com/certificates/css',
      icon: '🎨',
      color: '#264de4',
      category: 'web',
      status: 'completed',
    ...
    {
      id: 'generative-ai-geeks',
      title: 'Generative AI',
      issuer: 'GeeksforGeeks',
      date: '2024',
      description: 'Advanced certification in Generative AI technologies, covering modern AI applications, machine learning models, and AI integration in software development.',
      skills: ['Generative AI', 'Machine Learning', 'AI Applications', 'Model Integration', 'AI Development'],
      credentialUrl: 'https://www.geeksforgeeks.org/certificate/generative-ai',
      icon: '🤖',
      color: '#43e97b',
      category: 'ai',
      status: 'completed',
